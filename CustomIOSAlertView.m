...
//            NSLog(@"show---%lf ==%lf",screenSize.height ,dialogSize.height);
...
- (void)keyboardWillHide: (NSNotification *)notification
{
    ...
    NSLog(@"keyboardWillHide---%lf ==%lf",screenSize.height ,dialogSize.height);
    [UIView animateWithDuration:0.2f delay:0.0 options:UIViewAnimationOptionTransitionNone
					 animations:^{
...
-(void)upSize{
    ...
    CGRect frame_old =dialogView.frame;
    frame_old.origin.y -= 44;
    dialogView.frame = frame_old;
