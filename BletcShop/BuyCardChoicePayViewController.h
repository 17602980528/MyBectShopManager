//
//  BuyCardChoicePayViewController.h
//  BletcShop
//
...
@interface BuyCardChoicePayViewController : UIViewController<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic,retain)UITableView *myTable;

@property (nonatomic,retain)NSString *moneyString;//价格
