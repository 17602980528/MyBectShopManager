...
@implementation TwoBussinessView
...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [Btn1 setImage:[UIImage imageNamed:@"guanggao"] forState:UIControlStateNormal];
        self.Btn1 = Btn1;
        ...
        [Btn2 setImage:[UIImage imageNamed:@"dianpu"] forState:UIControlStateNormal];
        ...
        [Btn3 setImage:[UIImage imageNamed:@"zijin"] forState:UIControlStateNormal];
        ...
        [Btn4 setImage:[UIImage imageNamed:@"guanliyuan"] forState:UIControlStateNormal];
        ...
        [Btn5 setImage:[UIImage imageNamed:@"huiyuanzhi"] forState:UIControlStateNormal];
        ...
        Btn6.frame = CGRectMake(30, 20, (SCREENWIDTH-180)/3,(2*SCREENWIDTH/3-20-80 )/2);
        ...
        UIView *line5 = [[UIView alloc]initWithFrame:CGRectMake(0, 0, self.width, 1)];
...
-(void)shopManager
{
    ShopManagerViewController *shopManegerView = [[ShopManagerViewController alloc]init];
