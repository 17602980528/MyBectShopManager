...
@interface ValuePickerViewEric ()<UIPickerViewDataSource, UIPickerViewDelegate>
...
@implementation ValuePickerViewEric
...
- (UIView *)pickerView:(UIPickerView *)pickerView
    ...
    if (pickerLabel == nil) {
        CGRect frame = CGRectMake(0.0, 0.0, SCREENWIDTH, 60);
...
{
    self.valueDidSelect(self.stateStr,self.selectedRow);
