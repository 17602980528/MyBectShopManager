//
//  AddVipTableViewCell.m
//  BletcShop
//
//  Created by Bletc on 16/4/28.
//  Copyright © 2016年 bletc. All rights reserved.
//

#import "AddVipTableViewCell.h"

@implementation AddVipTableViewCell
...
-(void)_initUI
{
    ...
    [eidiBtn setTitle:@"查看" forState:UIControlStateNormal];
    [eidiBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [eidiBtn setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    eidiBtn.titleLabel.font = [UIFont systemFontOfSize:14];
    ...
    //    xnameLab.text = @"BLetc";
    xnameLab.font = [UIFont systemFontOfSize:14];
    ...
    adressLab.font = [UIFont systemFontOfSize:14];
...
-(void)layoutSubviews
{
    ...
    self.phoneLab.frame =CGRectMake(self.xnameLab.width+self.sexLab.width+2, 0, 120, 50);
    self.codeLab.frame = CGRectMake(self.xnameLab.width+self.sexLab.width+self.phoneLab.width+3, 0, 100, 50);
    self.adressLab.frame = CGRectMake(self.xnameLab.width+self.sexLab.width+self.phoneLab.width+self.codeLab.width+4, 0, 150, 50);
    self.eiditBtn.frame = CGRectMake(self.xnameLab.width+self.sexLab.width+self.phoneLab.width+self.codeLab.width+self.adressLab.width+5, 0, 70, 50);
    self.buyBtn.frame = CGRectMake(self.xnameLab.width+self.sexLab.width+self.phoneLab.width+self.codeLab.width+self.adressLab.width+self.eiditBtn.width+6, 0, 80, 50);
...
//    self.codeLab.frame = CGRectMake(self.eiditBtn.width+self.buyBtn.width+self.xnameLab.width+self.sexLab.width+self.phoneLab.width+self.adressLab.width+6,0 , 150, 50);
    ...
    self.view4.frame = CGRectMake(self.xnameLab.width+self.sexLab.width+self.phoneLab.width+self.codeLab.width+3, 0, 1, 50);
    self.view5.frame = CGRectMake(self.xnameLab.width+self.sexLab.width+self.phoneLab.width+self.codeLab.width+self.adressLab.width+4, 0, 1, 50);
    self.view6.frame = CGRectMake(self.xnameLab.width+self.sexLab.width+self.phoneLab.width+self.codeLab.width+self.adressLab.width+self.eiditBtn.width+5, 0, 1, 50);
