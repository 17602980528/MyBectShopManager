...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        self.textForNormalState = @"上拉查看更多";
...
- (void)layoutSubviews
{
    ...
    //在没有tablebar的情况下，center下移tabbar的高度49
    self.center = CGPointMake(self.scrollView.sd_width * 0.5, self.scrollView.contentSize.height + self.sd_height * 0.5 + self.scrollView.contentInset.bottom+49);
