...
@interface NewMessageVC ()<EMClientDelegate,EMChatManagerDelegate,UITableViewDataSource,UITableViewDelegate>
{
...
- (void)viewDidLoad {
    ...
    // 创建tableview
    UITableView *tableView = [[UITableView alloc]initWithFrame:CGRectMake(0,0 , kWeChatScreenWidth, kWeChatScreenHeight-64) style:UITableViewStylePlain];
    ...
    __block NewMessageVC *blockSelf = self;
