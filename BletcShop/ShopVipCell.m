...
@interface ShopVipCell()


@end

@implementation ShopVipCell
...
-(void)layoutSubviews
{
    ...
    self.adressLab.frame = CGRectMake(self.sexLab.width+self.phoneLab.width+self.xnameLab.width+3, 0, 152, 50);
//    self.codeLab.frame = CGRectMake(self.phoneLab.width+self.adressLab.width+self.xnameLab.width+self.sexLab.width+4, 0, 120, 50);
    self.eiditBtn.frame = CGRectMake(self.adressLab.width+self.xnameLab.width+self.sexLab.width+self.phoneLab.width+5, 0, 70, 50);
    self.buyBtn.frame = CGRectMake(self.adressLab.width+self.xnameLab.width+self.sexLab.width+self.phoneLab.width+self.eiditBtn.width+6,0 , 80, 50);
    ...
    self.view4.frame = CGRectMake(self.xnameLab.width+self.sexLab.width+self.phoneLab.width+self.adressLab.width+3, 0, 1, 50);
    self.view5.frame = CGRectMake(self.xnameLab.width+self.sexLab.width+self.phoneLab.width+self.adressLab.width+4, 0, 1, 50);
    self.view6.frame = CGRectMake(self.xnameLab.width+self.sexLab.width+self.phoneLab.width+self.adressLab.width+self.eiditBtn.width+5, 0, 1, 50);
    self.view7.frame = CGRectMake(0, self.height-1, self.eiditBtn.width+self.buyBtn.width+self.xnameLab.width+self.sexLab.width+self.phoneLab.width+self.adressLab.width+5+150, 1);
