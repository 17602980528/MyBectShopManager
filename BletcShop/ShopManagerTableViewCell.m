...
-(void)_initUI
{
    ...
    [eidiBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
...
-(void)layoutSubviews
{
    ...
    self.xnameLab.frame = CGRectMakeNew(0, 0, 100, 50);
    
    self.sexLab.frame = CGRectMake(self.xnameLab.width+1, 0, 130, 50);
    self.phoneLab.frame = CGRectMake(self.xnameLab.width+self.sexLab.width+2, 0, 100, 50);
    self.adressLab.frame = CGRectMake(self.phoneLab.width+self.xnameLab.width+self.sexLab.width+3, 0, 150, 50);
    self.eiditBtn.frame = CGRectMake(self.adressLab.width+self.xnameLab.width+self.sexLab.width+self.phoneLab.width+4, 0, 100, 50);
    self.buyBtn.frame = CGRectMake(self.adressLab.width+self.xnameLab.width+self.sexLab.width+self.phoneLab.width+self.eiditBtn.width+5, 0, 100, 50);
    self.view1.frame = CGRectMake(self.xnameLab.width, 0, 1, 50);
    self.view2.frame = CGRectMake(self.sexLab.width+self.xnameLab.width+1, 0, 1, 50);
    self.view3.frame =CGRectMake(self.phoneLab.width+self.xnameLab.width+self.sexLab.width+2, 0, 1, 50);
    self.view4.frame =CGRectMake(self.adressLab.width+self.xnameLab.width+self.sexLab.width+self.phoneLab.width+3, 0, 1, 50);
    self.view5.frame =CGRectMake(self.eiditBtn.width+self.xnameLab.width+self.sexLab.width+self.phoneLab.width+self.adressLab.width+4, 0, 1, 50);
    self.view6.frame =CGRectMake(self.eiditBtn.width+self.xnameLab.width+self.sexLab.width+self.phoneLab.width+self.adressLab.width+self.buyBtn.width+5, 0, 1, 50);
    self.view7.frame =CGRectMake(0, self.height-1, SCREENWIDTH*2, 1);
//    self.eiditBtn.frame = CGRectMakeNew(0, 0, 100, 50);
//    
//    self.xnameLab.frame = CGRectMake(self.eiditBtn.width+1, 0, 100, 50);
//    self.sexLab.frame = CGRectMake(self.eiditBtn.width+self.xnameLab.width+2, 0, 130, 50);
//    self.phoneLab.frame = CGRectMake(self.eiditBtn.width+self.xnameLab.width+self.sexLab.width+3, 0, 100, 50);
//    self.adressLab.frame = CGRectMake(self.eiditBtn.width+self.xnameLab.width+self.sexLab.width+self.phoneLab.width+4, 0, 150, 50);
//    
//    self.view1.frame = CGRectMake(self.eiditBtn.width, 0, 1, 50);
//    self.view2.frame = CGRectMake(self.eiditBtn.width+self.xnameLab.width+1, 0, 1, 50);
//    self.view3.frame =CGRectMake(self.eiditBtn.width+self.xnameLab.width+self.sexLab.width+2, 0, 1, 50);
//    self.view4.frame =CGRectMake(self.eiditBtn.width+self.xnameLab.width+self.sexLab.width+self.phoneLab.width+3, 0, 1, 50);
//    self.view5.frame =CGRectMake(self.eiditBtn.width+self.xnameLab.width+self.sexLab.width+self.phoneLab.width+self.adressLab.width+4, 0, 1, 50);
